...
;;; 2022.11.30 It was added functions by A.honda
;;; Rev.B03
...
;	MEMORY ASIGN
ROM_B	equ	0000H	; ROM base address
RAM_B	equ	8000H	; RAM base address
RAMSIZ	EQU	4000H
RAM_E	equ	RAM_B + RAMSIZ - 1 ; RAM END address

RBFSIZ	EQU	40H	; SIO recieve buffer size

WORK_SIZE	equ	256		;monitor work area size
...
lanch3:
	dw	POTB_CST
	DB	"3. POTB Start",CR,LF,00H
		
lanch4:
	dw	POTB_WST
	DB	"4. POTB Restart",CR,LF,00H
